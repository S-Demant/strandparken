...
<div class="container mt-120">
    <span class="text-dark text-opacity-25"><a href="index.php" class="link-primary crumb">Forside</a> / <a href="attractions.php" class="link-primary crumb">Attraktioner</a> / <a href="#" class="link-primary crumb">Titel på attraktionen</a></span>
</div>

<div class="container position-relative">
    <div class="row">
        <h2 class="mt-4">Attraktioner</h2>
        ...
        <div class="col-12 col-lg-6 mt-3 ps-lg-4">
            <a href="#" class="link-dark"><h2>Titel på attraktionen</h2></a>
...
<div class="container info">
    <div class="row">
        <div class="col-12 col-lg-6">
            <h2>Information</h2>
            <p>Besøg attraktionens hjemmeside for mere information, billet reservation, og lignende.</p>
            <img src="img/qr.webp">
        </div>
    </div>
</div>
...
<div class="container position-relative mt-5">
    <div class="row row-gap-4">
        ...
        <div class="col-12 col-lg-4 d-flex flex-column position-relative mb-3">
            <img src="img/image.webp" class="img-fluid w-100">
            <h2 class="mt-3">Titel på attraktionen</h2>
